...
Повышение контраста изображения — это базовая операция в обработке изображений, которая позволяет усилить различие между светлыми и тёмными участками. Это полезно для улучшения визуального восприятия и подготовки изображений к дальнейшей обработке, например, в системах компьютерного зрения.
